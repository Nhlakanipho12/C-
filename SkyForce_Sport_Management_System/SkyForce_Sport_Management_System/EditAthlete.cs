...
{
    public partial class EditAthlete : Form
    {
        ...
        void GridFill()
        {
            ...
            using (MySqlConnection mysqlCo = new MySqlConnection(connectionString))
            {
                ...
                dgShow.Columns[11].Visible = false;
                dgShow.Columns[10].Visible = false ;
        ...
        private void EditAthlete_Load(object sender, EventArgs e)
        {
           GridFill();
            Clear();
        }
